...
- **参考感知选择：**只有 PM、设计、动效、生态资源发现和上下文压缩信号能改善当前 workflow 时才按需使用，不复制第三方内容。
...
| `upstream-sources.json` | PM、官方 frontend-design、官方 GSAP、shadcn/ui、设计品味和上下文压缩外部参考来源的 baseline。 |
| `AGENTS.md` | 本仓库维护规则。 |
