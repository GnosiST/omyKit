...
- Use `deck.proposal` for PPT, presentation, slide, pitch-deck, or proposal-deck work; the intake should offer direction options, record the selected production surface, and keep same-lane deck skill fallback auditable instead of stacking every PPT skill.
