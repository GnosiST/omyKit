...
| [Tool registry](workflow/tool-registry.md) | How Codex combines tools and applies PM, UI design, design-taste, and ecosystem patterns without using all tools by default. |
