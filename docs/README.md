...
| [Tool registry](workflow/tool-registry.md) | How Codex selects tools and optional PM, UI design, motion, design-taste, ecosystem, and context-compression patterns without using all tools by default. |
